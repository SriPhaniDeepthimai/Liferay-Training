...
package Prac_Service_Builder.service.persistence.test;

import Prac_Service_Builder.exception.NoSuchFooException;

import Prac_Service_Builder.model.Foo;

import Prac_Service_Builder.service.FooLocalServiceUtil;
...
public class FooPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "Prac_Service_Builder.service"));
	...
	protected OrderByComparator<Foo> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"FOO_Foo", "fooId", true, "groupId", true, "companyId", true,
