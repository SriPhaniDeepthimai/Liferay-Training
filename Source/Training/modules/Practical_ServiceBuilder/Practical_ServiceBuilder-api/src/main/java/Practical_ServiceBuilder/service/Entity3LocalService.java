...
/**
 * Provides the local service interface for Entity3. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Entity3LocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Entity3LocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>Practical_ServiceBuilder.service.impl.Entity3LocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the entity3 local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Entity3LocalServiceUtil} if injection and service tracking are not available.
	 */
