...
/**
 * Provides the local service interface for Entity4. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Entity4LocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Entity4LocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>Practical_ServiceBuilder.service.impl.Entity4LocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the entity4 local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Entity4LocalServiceUtil} if injection and service tracking are not available.
	 */
