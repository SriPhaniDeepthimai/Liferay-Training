...
import com.Students.Details.service.TeacherDetailsLocalService;
...
/**
 * Provides the base implementation for the teacher details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.Students.Details.service.impl.TeacherDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.Students.Details.service.impl.TeacherDetailsLocalServiceImpl
 * @generated
 */
public abstract class TeacherDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TeacherDetailsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TeacherDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.Students.Details.service.TeacherDetailsLocalServiceUtil</code>.
	 */
	...
	public TeacherDetails addTeacherDetails(TeacherDetails teacherDetails) {
		...
		return teacherDetailsPersistence.update(teacherDetails);
	}
	...
	public TeacherDetails createTeacherDetails(int Teacher_Id) {
		return teacherDetailsPersistence.create(Teacher_Id);
	}
	...
	public TeacherDetails deleteTeacherDetails(int Teacher_Id)
		...
		return teacherDetailsPersistence.remove(Teacher_Id);
	}
	...
	public TeacherDetails deleteTeacherDetails(TeacherDetails teacherDetails) {
		return teacherDetailsPersistence.remove(teacherDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return teacherDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TeacherDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return teacherDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return teacherDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return teacherDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return teacherDetailsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TeacherDetails fetchTeacherDetails(int Teacher_Id) {
		return teacherDetailsPersistence.fetchByPrimaryKey(Teacher_Id);
	}
	...
	public TeacherDetails fetchTeacherDetailsByUuidAndGroupId(
		...
		return teacherDetailsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public TeacherDetails getTeacherDetails(int Teacher_Id)
		...
		return teacherDetailsPersistence.findByPrimaryKey(Teacher_Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(teacherDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TeacherDetails.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TeacherDetails.class);
			...
			new ActionableDynamicQuery.PerformActionMethod<TeacherDetails>() {
				...
				public void performAction(TeacherDetails teacherDetails)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, teacherDetails);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return teacherDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TeacherDetailsLocalServiceImpl#deleteTeacherDetails(TeacherDetails) to avoid orphaned data");
		}

		return teacherDetailsLocalService.deleteTeacherDetails(
			(TeacherDetails)persistedModel);
	}

	@Override
	public BasePersistence<TeacherDetails> getBasePersistence() {
		return teacherDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return teacherDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TeacherDetails> getTeacherDetailsesByUuidAndCompanyId(
		...
		return teacherDetailsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TeacherDetails> getTeacherDetailsesByUuidAndCompanyId(
		...
		return teacherDetailsPersistence.findByUuid_C(
	...
	public TeacherDetails getTeacherDetailsByUuidAndGroupId(
		...
		return teacherDetailsPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<TeacherDetails> getTeacherDetailses(int start, int end) {
		return teacherDetailsPersistence.findAll(start, end);
	}
	...
	public int getTeacherDetailsesCount() {
		return teacherDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TeacherDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		teacherDetailsLocalService = (TeacherDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TeacherDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = teacherDetailsPersistence.getDataSource();
	...
	protected TeacherDetailsLocalService teacherDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TeacherDetailsLocalServiceBaseImpl.class);
