...
import com.Students.Details.service.Students_MarksLocalService;
...
/**
 * Provides the base implementation for the students_ marks local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.Students.Details.service.impl.Students_MarksLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.Students.Details.service.impl.Students_MarksLocalServiceImpl
 * @generated
 */
public abstract class Students_MarksLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, Students_MarksLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Students_MarksLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.Students.Details.service.Students_MarksLocalServiceUtil</code>.
	 */
	...
	public Students_Marks addStudents_Marks(Students_Marks students_Marks) {
		...
		return students_MarksPersistence.update(students_Marks);
	}
	...
	public Students_Marks createStudents_Marks(int Student_Id) {
		return students_MarksPersistence.create(Student_Id);
	}
	...
	public Students_Marks deleteStudents_Marks(int Student_Id)
		...
		return students_MarksPersistence.remove(Student_Id);
	}
	...
	public Students_Marks deleteStudents_Marks(Students_Marks students_Marks) {
		return students_MarksPersistence.remove(students_Marks);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return students_MarksPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Students_Marks.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return students_MarksPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return students_MarksPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return students_MarksPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return students_MarksPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Students_Marks fetchStudents_Marks(int Student_Id) {
		return students_MarksPersistence.fetchByPrimaryKey(Student_Id);
	}
	...
	public Students_Marks fetchStudents_MarksByUuidAndGroupId(
		...
		return students_MarksPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Students_Marks getStudents_Marks(int Student_Id)
		...
		return students_MarksPersistence.findByPrimaryKey(Student_Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(students_MarksLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Students_Marks.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Students_Marks.class);
			...
			new ActionableDynamicQuery.PerformActionMethod<Students_Marks>() {
				...
				public void performAction(Students_Marks students_Marks)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, students_Marks);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return students_MarksPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement Students_MarksLocalServiceImpl#deleteStudents_Marks(Students_Marks) to avoid orphaned data");
		}

		return students_MarksLocalService.deleteStudents_Marks(
			(Students_Marks)persistedModel);
	}

	@Override
	public BasePersistence<Students_Marks> getBasePersistence() {
		return students_MarksPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return students_MarksPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Students_Marks> getStudents_MarksesByUuidAndCompanyId(
		...
		return students_MarksPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Students_Marks> getStudents_MarksesByUuidAndCompanyId(
		...
		return students_MarksPersistence.findByUuid_C(
	...
	public Students_Marks getStudents_MarksByUuidAndGroupId(
		...
		return students_MarksPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Students_Marks> getStudents_Markses(int start, int end) {
		return students_MarksPersistence.findAll(start, end);
	}
	...
	public int getStudents_MarksesCount() {
		return students_MarksPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			Students_MarksLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		students_MarksLocalService = (Students_MarksLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return Students_MarksLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = students_MarksPersistence.getDataSource();
	...
	protected Students_MarksLocalService students_MarksLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		Students_MarksLocalServiceBaseImpl.class);
